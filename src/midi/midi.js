	...
	*/
	...
	var requestQueue = function requestQueue(opts, context) {
	  ...
	  var waitForEnd = function waitForEnd() {
		...
		// /
		waitForEnd();
		// Harry: I've commented the following out because webpack makes loading
		// soundfonts from the public directory hard to manage. Instead, I load the
		// soundfonts myself in the setMidiContextAsync() function.
